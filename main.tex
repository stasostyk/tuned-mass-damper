...
\newpage
\section{Appendix A}
To find the uncertainty, $\Delta \zeta$, where $\zeta$ defined as: 
$$
\zeta=\frac{\Delta d_1^2-(\frac{a_2}{4\pi^2f^2})^2}{\Delta d_1^2} \times 100\%
$$
Since constant constant terms can be ignored when calculating for uncertainty, $\zeta$ can be simplified to:
$$(\frac{100}{16\pi^4\Delta {d_1}^2})(\frac{{a_2}^2}{f^4})$$

Now, using the three uncertainty rules from the data booklet, $\Delta \zeta$ can be calculated using:

$$x=a_2^2 \rightarrow \frac{\Delta x}{x}=\mid2\frac{\Delta a_2}{a_2}\mid \rightarrow \Delta x = 2a_2\Delta a_2$$
